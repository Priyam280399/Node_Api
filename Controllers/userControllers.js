...
exports.userpost = async (req, res) => {
    ...
    try {
        ...
        console.log("error is due to:",error.toString());
        res.status(400).json({error:"catch block error"});
    }
}
...
exports.getUsers = async (req, res) => {
    ...
    try {
      ...
      // Apply the .sort() method on the result of the find() method
